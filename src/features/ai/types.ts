...
export const emptyResumeAnalysis = {
  ...
  achievements_analysis: {
    quantified: [] as string[],
    findings: [] as string[],
    recommendations: [] as string[],
  },
  improvement_checklist: [] as Array<{
    item: string;
...
export const emptyCareerPlan = {
  ...
  monthly_roadmap: [] as Array<{
    week: string;
    theme: string;
    milestones: string[];
    deliverables: string[];
  }>,
  skill_recommendations: [] as Array<{
    name: string;
    category: string;
    priority: "high" | "medium" | "low";
  ...
  learning_recommendations: [] as Array<{
    title: string;
    provider: string;
    type: string;
    url_hint: string;
  ...
  internship_recommendations: [] as Array<{
    company: string;
    role: string;
    type: string;
    why: string;
  ...
  company_recommendations: [] as Array<{
    name: string;
    why: string;
    tier: "reach" | "target" | "safety";
    roles: string[];
  }>,
  technology_recommendations: [] as Array<{
    name: string;
    category: string;
    priority: "high" | "medium" | "low";
    why: string;
  }>,
  certification_recommendations: [] as Array<{
    name: string;
    provider: string;
    difficulty: string;
