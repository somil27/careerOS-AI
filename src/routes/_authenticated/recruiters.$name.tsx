    ...
    <div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="text-xs text-muted-foreground flex items-center gap-1">
              <User className="size-3.5" /> Applications
            </div>
            ...
            <div className="flex flex-wrap gap-1">
              {companies.map((c) => (
                <Link
                  ...
                  className="px-2 py-0.5 rounded bg-accent text-xs hover:underline"
                >
                  {c}
                </Link>
              ))}
      ...
      <Card>
        <CardContent className="p-0 overflow-x-auto">
          {apps.length === 0 ? (
            <div className="p-8 text-sm text-muted-foreground text-center">No applications.</div>
          ) : (
